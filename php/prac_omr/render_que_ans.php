...
if(isset($_GET['testname'])){
    ...
    $data = mysqli_query($conn,"Select * from prac_questions where name='$testname'");   
    ...
    $attempt_info = "SELECT total_questions from prac_attempts where test_name='$testname' and attempt=$attempt";
    ...
    $user_answer = "SELECT * from prac_attempts where user_id='".$u_name."' and attempt=".$attempt." and test_name='".$testname."'";
    $org_answer = "SELECT answer,positive,negative from prac_questions where name='$testname'";
