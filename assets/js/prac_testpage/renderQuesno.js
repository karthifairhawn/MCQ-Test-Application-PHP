function load_question_1(){
    ...
    request.open("GET", "./php/prac_testpage/load_question_1.php?name="+testname+"&attempt="+attempt);
...
function renderQuesNo() {
    var request = new XMLHttpRequest();
    var testname= document.getElementById('testname').innerText;    
    request.open("GET", "./php/prac_testpage/update-quesno.php?name="+testname);
    request.onreadystatechange = function() {
        if(this.readyState === 4 && this.status === 200) {
