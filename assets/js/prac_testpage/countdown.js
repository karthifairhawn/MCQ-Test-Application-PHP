...
document.addEventListener("DOMContentLoaded", function(){
    ...
    request.open("GET", "./php/prac_testpage/update_time.php?name="+testname);
    ...
    function updatetime(){
        ...
        function updatetime(){
            ...
            var time_request = new XMLHttpRequest();
                    ...
                    time_request.open("GET", "./php/prac_testpage/update_cd.php?time="+rem_seconds);
            ...
            if (minutes<0){
                ...
                setTimeout(() => { window.location.href = 'prac_result.php?testname='+testname+'&attempt='+attempt+'&from_test='+'true'; }, 2000);
...
window.onbeforeunload = function() {
    return "Are u sure want to submit test ?";
}
