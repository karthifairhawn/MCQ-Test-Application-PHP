function render_ques_no_onclick(ques){
    ...
    request.open("GET", "./php/prac_testpage/update-quesno_onclick.php?name="+testname);
...
function load_question(ques_no,pane=false){
    ...
    request.open("GET", "./php/prac_testpage/next_pre_button.php?name="+testname+"&quesno="+ques_no+"&attempt="+attempt);
    request.onreadystatechange = function() {
        if(this.readyState === 4 && this.status === 200) {
